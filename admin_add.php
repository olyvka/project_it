...
?>
	<h4 class="fw-bolder text-center">Добавити новий товар</h4>
	<center>
					...
					<div class="container-fluid">
						...
						<form method="post" action="admin_add.php" enctype="multipart/form-data">
								...
								<div class="mb-3">
									...
									<input class="form-control rounded-3" type="text" name="title" required>
								</div>
								<div class="mb-3">
									<label class="control-label">Автор</label>
									<input class="form-control rounded-3" type="text" name="author" required>
								</div>
							
								<div class="mb-3">
									<label class="control-label">Зображення</label>
									<input class="form-control rounded-3" type="file" name="image">
								</div>
								<div class="mb-3">
									<label class="control-label">Опис</label>
									<textarea class="form-control rounded-3" name="descr" cols="40" rows="5"></textarea>
								</div>
								<div class="mb-3">
									<label class="control-label">Ціна</label>
									<input class="form-control rounded-3" type="text" name="price" required>
								</div>
								<div class="mb-3">
									<label class="control-label">Видавництво</label>
									<select class="form-select rounded-3"  name="publisher" required>
										<option value="" disabled selected>Виберіть тут</option>
										<?php 
								...
								<div class="text-center">
									<button type="submit" name="add"  class="btn btn-primary btn-sm rounded-3">Зберегти</button>
									<button type="reset" class="btn btn-default btn-sm rounded-3 border">Скасувати</button>
								</div>
						</form>
					</div>
				</div>
