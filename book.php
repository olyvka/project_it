...
?>
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="books.php" class="text-decoration-none text-muted fw-light">Видавництва</a></li>
                ...
                <hr>
                  ...
                  <form method="post" action="cart.php">
                    ...
                    <div class="text-center">
                      <input type="submit" value="Придбати / Додати в кошик" name="cart" class="btn btn-primary rounded-3">
                    </div>
                  </form>
              </div>
            </div>
