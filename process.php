<?php
	...
	session_unset();
?>
	<div class="alert alert-success rounded-3 my-4">Ваше замовлення успішно оброблено. Ми зв’яжемося з вами, щоб підтвердити ваше замовлення. Дякую!<br>Пам'ятайте Москалі не люди!</br></div>
